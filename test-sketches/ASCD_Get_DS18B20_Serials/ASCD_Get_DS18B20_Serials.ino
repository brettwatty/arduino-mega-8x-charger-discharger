// ASDC Mega 8x Arduino Charger / Discharger
// ---------------------------------------------------------------------------
...
#define ONE_WIRE_BUS 4 // Pin 2 Version 1.0+ Temperature Sensors | Pin 4 for Version 2.0+
...
byte deviceCount = 9; // 9 in the ASDC Mega 8x Arduino Charger / Discharger
...
void printAddress(DeviceAddress deviceAddress, bool first, bool last, bool comma)
{
  if (first)
  {
    Serial.println("DeviceAddress tempSensorSerial[9]= {{");
  }
  else
  {
    Serial.print("{");
